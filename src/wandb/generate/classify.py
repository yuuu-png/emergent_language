...
from src.wandb.generate.train import GenerateModule
...
def main(config):
    ...
    generateModule = GenerateModule.load_from_checkpoint(
        checkpoint,
    ...
    dataset = (
        ...
        else generateModule.hparams["dataset"]
    )
    if dataset == "mnist":
        dm = MNISTDataModule(
